    ...
    return (
      <main >
          ...
          <a href = "https://github.com/JoseBorbon" target ="_blank" rel="noreferrer" className = "about-jose-profile"><img src ={jose} alt ="jose's profile"/> </a>
              ...
              <a href = "https://github.com/kisublee" target ="_blank"rel="noreferrer" className = "about-ki-sub-profile"> <img src ={kisub} alt ="kisub's profile"/> </a>
              ...
              <a href = "https://github.com/Jalamang" target ="_blank" rel="noreferrer" className = "about-jalamang-profile ">
