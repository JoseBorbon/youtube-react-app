        ...
        <div className="about-jose-profile">
          ...
          <div className="jose-learn-about-page">
            ...
            <p>
              ...
              and I'm a volunteer co-organizer for NYC Coders. My
              extracurricular activities include running marathons, traveling,
              watching anime, playing video games and building computers.
            </p>
          </div>
        </div>
        ...
        <div className="about-ki-sub-profile">
          ...
          <div className="kisub-learn-about-page">
            ...
            <p>
              ...
              the USA. During my spare time, I like to run, paint, or play
              soccer.
            </p>
          </div>
        </div>
        ...
        <div className="about-jalamang-profile">
          ...
          <div className="jalamang-learn-about-page">
            ...
            <p>
              ...
              knowledge in Java, Python, CSS, JavaScript, and SQL/Oracle
              Database.
            </p>
          </div>
        </div>
        <h3 className="ad">
          Wanna Join Us? <br></br>Check out our Career page!
        </h3>
      </article>
    </main>
  );
